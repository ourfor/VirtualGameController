...
import Foundation
    ...
    open class VgcController: NSObject, StreamDelegate, VgcStreamerDelegate, NetServiceDelegate {
        open weak var peripheral: Peripheral!
        ...
        open var isHardwareController: Bool { return self.hardwareController != nil }
        ...
        func setupHardwareControllerMotionHandlers() {
            ...
            hardwareController.motion?.valueChangedHandler = { (_: GCMotion) in
        ...
        func setupHardwareControllerForwardingHandlers() {
            ...
            let dpadValueChangedHandler = { (_: GCControllerDirectionPad!, x: Float, y: Float) in
            ...
            let leftThumbstickChangedHandler = { (_: GCControllerDirectionPad!, x: Float, y: Float) in
            ...
            let rightThumbstickChangedHandler = { (_: GCControllerDirectionPad!, x: Float, y: Float) in
            ...
            controllerPausedHandler = { (_: VgcController) in
    ...
    // MARK: - MicroGamepad Profile
        ...
        public class VgcMicroGamepad: GCMicroGamepad {
            ...
            public override var dpad: GCControllerDirectionPad { if vgcController?.deviceInfo.controllerType == .MFiHardware && (vgcDpad.yAxis.value == 0 && vgcDpad.xAxis.value == 0) { return vgcController!.hardwareController.microGamepad!.dpad } else { return vgcDpad } }
            
            public override var buttonA: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonA.value == 0 { return vgcController!.hardwareController.microGamepad!.buttonA } else { return vgcButtonA } }
            public override var buttonX: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonX.value == 0 { return vgcController!.hardwareController.microGamepad!.buttonX } else { return vgcButtonX } }
            ...
            public override var valueChangedHandler: GCMicroGamepadValueChangedHandler? {
                ...
                set {
                    ...
                    if vgcController?.hardwareController != nil {
                        vgcController?.hardwareController.microGamepad?.valueChangedHandler = { (_: GCMicroGamepad, element: GCControllerElement) in
    ...
    open class VgcGamepad: GCGamepad {
        ...
        open override var leftShoulder: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcLeftShoulder.value == 0 { return vgcController!.hardwareController.gamepad!.leftShoulder } else { return vgcLeftShoulder } }
        open override var rightShoulder: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcRightShoulder.value == 0 { return vgcController!.hardwareController.gamepad!.rightShoulder } else { return vgcRightShoulder } }
        open override var dpad: GCControllerDirectionPad { if vgcController?.deviceInfo.controllerType == .MFiHardware && (vgcDpad.yAxis.value == 0 && vgcDpad.xAxis.value == 0) { return vgcController!.hardwareController.gamepad!.dpad } else { return vgcDpad } }
        open override var buttonA: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonA.value == 0 { return vgcController!.hardwareController.gamepad!.buttonA } else { return vgcButtonA } }
        open override var buttonB: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonB.value == 0 { return vgcController!.hardwareController.gamepad!.buttonB } else { return vgcButtonB } }
        open override var buttonX: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonX.value == 0 { return vgcController!.hardwareController.gamepad!.buttonX } else { return vgcButtonX } }
        open override var buttonY: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcLeftShoulder.value == 0 { return vgcController!.hardwareController.gamepad!.buttonY } else { return vgcButtonY } }
        ...
        /// hardware controller.
        ///
        open override weak var controller: GCController? {
        ...
        open override var valueChangedHandler: GCGamepadValueChangedHandler? {
            ...
            set {
                vgcValueChangedHandler = newValue
                if vgcController?.hardwareController != nil { vgcController?.hardwareController.gamepad?.valueChangedHandler = { (_: GCGamepad, element: GCControllerElement) in
        ...
        open func vgcSaveSnapshot() -> VgcGamepadSnapshot {
            let snapshot = VgcGamepadSnapshot(controller: vgcController!)
            return snapshot
        }
    }
    ...
    open class VgcExtendedGamepad: GCExtendedGamepad {
        ...
        open override var leftShoulder: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcLeftShoulder.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.leftShoulder)! } else { return vgcLeftShoulder } }
        
        open override var rightShoulder: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcRightShoulder.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.rightShoulder)! } else { return vgcRightShoulder } }
        
        open override var dpad: GCControllerDirectionPad { if vgcController?.deviceInfo.controllerType == .MFiHardware && (vgcDpad.yAxis.value == 0 && vgcDpad.xAxis.value == 0) { return (vgcController?.hardwareController.extendedGamepad!.dpad)! } else { return vgcDpad } }
        
        open override var buttonA: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonA.value == 0 {
            return (vgcController?.hardwareController.extendedGamepad!.buttonA)!
        } else {
            return vgcButtonA } }
        
        open override var buttonB: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonB.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.buttonB)! } else { return vgcButtonB } }
        
        open override var buttonX: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonX.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.buttonX)! } else { return vgcButtonX } }
        
        open override var buttonY: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcButtonY.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.buttonY)! } else { return vgcButtonY } }
        
        // Extended profile-specific properties
        open override var leftTrigger: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcLeftTrigger.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.leftTrigger)! } else { return vgcLeftTrigger } }
        
        open override var rightTrigger: GCControllerButtonInput { if vgcController?.deviceInfo.controllerType == .MFiHardware && vgcRightTrigger.value == 0 { return (vgcController?.hardwareController.extendedGamepad!.rightTrigger)! } else { return vgcRightTrigger } }
        
        open override var leftThumbstick: GCControllerDirectionPad { if vgcController?.deviceInfo.controllerType == .MFiHardware && (vgcLeftThumbstick.yAxis.value == 0 && vgcLeftThumbstick.xAxis.value == 0) { return (vgcController?.hardwareController.extendedGamepad!.leftThumbstick)! } else { return vgcLeftThumbstick } }
        
        open override var rightThumbstick: GCControllerDirectionPad { if vgcController?.deviceInfo.controllerType == .MFiHardware && (vgcRightThumbstick.yAxis.value == 0 && vgcRightThumbstick.xAxis.value == 0) { return (vgcController?.hardwareController.extendedGamepad!.rightThumbstick)! } else { return vgcRightThumbstick } }
        ...
        open override var valueChangedHandler: GCExtendedGamepadValueChangedHandler? {
            ...
            set {
                ...
                if vgcController?.hardwareController != nil { vgcController?.hardwareController.extendedGamepad?.valueChangedHandler = { (_: GCExtendedGamepad, element: GCControllerElement) in
        ...
        open func vgcSaveSnapshot() -> VgcExtendedGamepadSnapshot {
            let snapshot = VgcExtendedGamepadSnapshot(controller: vgcController!)
            return snapshot
        }
    }
    ...
    open class VgcExtendedGamepadSnapshot: NSObject {
        ...
        open var dpad: GCControllerDirectionPad { return makeDirectionPad(snapshotV100Structure.dpadX, yAxis: snapshotV100Structure.dpadY, controller: controller, xElement: elements.dpadXAxis, yElement: elements.dpadYAxis) }
        open var buttonA: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonA, controller: controller, element: elements.buttonA) }
        open var buttonB: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonB, controller: controller, element: elements.buttonB) }
        open var buttonX: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonX, controller: controller, element: elements.buttonX) }
        open var buttonY: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonY, controller: controller, element: elements.buttonY) }
        open var leftShoulder: GCControllerButtonInput { return makeButton(snapshotV100Structure.rightShoulder, controller: controller, element: elements.leftShoulder) }
        open var rightShoulder: GCControllerButtonInput { return makeButton(snapshotV100Structure.leftShoulder, controller: controller, element: elements.rightShoulder) }
        open var leftTrigger: GCControllerButtonInput { return makeButton(snapshotV100Structure.leftTrigger, controller: controller, element: elements.leftTrigger) }
        open var rightTrigger: GCControllerButtonInput { return makeButton(snapshotV100Structure.rightTrigger, controller: controller, element: elements.rightTrigger) }
        open var rightThumbstick: GCControllerDirectionPad { return makeDirectionPad(snapshotV100Structure.rightThumbstickX, yAxis: snapshotV100Structure.rightThumbstickY, controller: controller, xElement: elements.rightThumbstickXAxis, yElement: elements.rightThumbstickYAxis) }
        open var leftThumbstick: GCControllerDirectionPad { return makeDirectionPad(snapshotV100Structure.leftThumbstickX, yAxis: snapshotV100Structure.leftThumbstickY, controller: controller, xElement: elements.dpadXAxis, yElement: elements.dpadYAxis) }
    ...
    open class VgcGamepadSnapshot: NSObject {
        ...
        public class VgcMicroGamepadSnapshot: NSObject {
            ...
            // Getters for the various elements that read from the struct
            public var dpad: GCControllerDirectionPad { return makeDirectionPad(snapshotV100Structure.dpadX, yAxis: snapshotV100Structure.dpadY, controller: controller, xElement: elements.dpadXAxis, yElement: elements.dpadYAxis) }
            public var buttonA: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonA, controller: controller, element: elements.buttonA) }
            public var buttonX: GCControllerButtonInput { return makeButton(snapshotV100Structure.buttonX, controller: controller, element: elements.buttonX) }
